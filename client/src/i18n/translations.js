export const translations = {
  es: {
    ...
    feedback: {
      ...
      subtitle: "¿Encontraste un bug o te gustaría alguna funcionalidad nueva? Contanoslo.",
      categoryLabel: "Tipo",
      category: {
        bug: "Bug",
        feature: "Idea / funcionalidad",
        other: "Otro",
      },
      message: "Mensaje",
      messagePlaceholder: "Contá qué pasó o qué te gustaría que tenga la app...",
      send: "Enviar",
      sent: "¡Gracias! Tu mensaje llegó al administrador.",
    },
    auth: {
    ...
    ledger: {
      ...
      noCategoriesYet: "Todavía no creaste ninguna categoría.",
    ...
    admin: {
      ...
      feedbackEmpty: "Todavía no llegó ningún feedback.",
      feedbackMarkReviewed: "Marcar revisado",
  ...
  en: {
    ...
    feedback: {
      title: "Send feedback",
      subtitle: "Found a bug or want a new feature? Let us know.",
      categoryLabel: "Type",
      category: {
        bug: "Bug",
      ...
      message: "Message",
      messagePlaceholder: "Tell us what happened or what you'd like the app to have...",
      send: "Send",
      sent: "Thanks! Your message reached the administrator.",
    },
    auth: {
      login: "Log in",
      loginCta: "Log in",
